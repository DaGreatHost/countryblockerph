...
*Maari ka na mag-join sa mga Filipino groups at auto-approve ka na agad!*
            """
...
**Para ma-verify:**
• Gamitin ang Philippine phone number (+63)
• I-check kung tama ang format
• Subukan ulit ang /start
...
*All systems operational! Enjoy your benefits.*
                """
            else:
...
*Ready to verify? Type /start now!*
            """
